...
mod vectors {
    ...
    fn valid_signature() {
        let verifying_key = VerifyingKey::from_bytes(
            &<[u8; 32]>::from_hex(
                "6073462394F5F6EA8D78E25DED3C0C5334EAD7813FEF8282CE1D72AFD126D32E",
            )
            .unwrap(),
        )
        .unwrap();
        ...
        let msg_bytes: Vec<u8> =
            FromHex::from_hex("13D4DBF09958FBFB733121F7268B67C3E9701BDF7D406B43B831F615D7AFFBA6")
                .unwrap();
        ...
        assert!(verifying_key.verify_strict(&msg_bytes, &signature).is_ok(),);
    }
    ...
    fn regression_validate_weird_signature() {
        ...
        let msg_bytes: Vec<u8> =
            FromHex::from_hex("E03D646E37DAE61E4D21281054418EF733CCFB9943B424B36B203ED063340A88")
                .unwrap();
